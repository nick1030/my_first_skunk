...
public class SkunkDomain
{
	...
	public boolean run()
	{
		...
		while (gameNotOver)
		{
			...
			while (wantsToRoll)
			{
				...
				else if (getDie1Roll() || getDie2Roll())
				{
	...
	private boolean getDie2Roll() {
		return skunkDice.getDie2().getLastRoll() == 1;
	}

	private boolean getDie1Roll() {
		return skunkDice.getDie1().getLastRoll() == 1;
	}
